...
const namespace = '/6nywdbo6r'
const producerKey = 'p34axz3b3'

const defaults = {
  title: 'term-cloud',
  clouds: {
    us: 'https://broadcast.mybluemix.net',
    eu: 'https://broadcast.eu-gb.mybluemix.net'
  },
...
cmd.usage('[options]')
  ...
  .on('--help', function () {
    ...
    console.log('    term-cloud -c eu --shell /bin/csh')
    console.log()
  })
  .parse(process.argv)
